...
class LRUCache(BaseCaching):
    ...
    def __init__(self):
        """Initialize the LRUCache class by calling the parent class's __init__ method"""
        super().__init__()
    ...
    def put(self, key, item):
        ...
        If the cache is full, discard the least recently used item (LRU algorithm).
        """
    ...
    def get(self, key):
        """Return the value associated with the given key in the cache data dictionary"""
